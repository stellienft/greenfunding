                ...
                <div className="px-6 pt-6 pb-0">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Prepare the intro email, then send the quote</p>
                    </div>
                  </div>
                    ...
                    <button
                      ...
                      className={`px-5 py-2.5 text-sm font-semibold transition-colors border-b-2 -mb-px ${
                        emailModalTab === 'intro'
                          ...
                          : 'border-transparent text-gray-500 hover:text-[#3A475B]'
                      }`}
                    >
                      Intro Email
                    </button>
                  ...
                  {emailModalTab === 'intro' ? (
                    <div className="space-y-4">
                      <p className="text-sm text-gray-600">
                        Copy this intro email and paste it into your own email client before sending the quote to your client.
                      </p>

                      <div>
                        <label className="block text-xs font-semibold text-[#3A475B] mb-1.5 uppercase tracking-wide">
                          Subject
                        </label>
                        <div className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-[#3A475B] font-medium">
                          {introEmailTemplate?.subject || 'Introduction to Green Funding – Solar Finance Options'}
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={13}
                          className="w-full px-3 py-3 border border-gray-300 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-[#28AA48] focus:border-transparent resize-none"
                        />
                      </div>
                      ...
                      <button
                        ...
                        className={`w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-bold text-sm transition-all ${
                          copiedIntro
                            ? 'bg-green-50 border-2 border-[#28AA48] text-[#28AA48]'
                      ...
                      <button
                        onClick={() => setEmailModalTab('quote')}
                        className="w-full px-4 py-2.5 bg-gray-100 text-[#3A475B] font-semibold rounded-lg hover:bg-gray-200 transition-colors text-sm"
                      >
                        Next: Send Quote Details
                      </button>
                    </div>
                  ) : (
                    <div className="space-y-4">
